                ...
                <div class="card-body">
                    ...
                    <form action="handleform" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <small id="inputName" class="form-text text-muted">We will never share your name with nanyone else</small> 
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="dob" type="text" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="dd/mm/yyyy">
                        </div>
